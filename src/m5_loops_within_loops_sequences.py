...
def run_test_integers():
    ...
    # Test 2:
    expected = [5, -3, -6, 7, -63, 246, 0, 2]
    list_of_lists = [[5, 6.6, -3], [-6, 7], [3.14159, -63, 246], [0], [], [1.345, 2, 5.5]]
    answer = integers(list_of_lists)
    print('Expected is: ', expected)
    print('Actual is: ', answer)
...
def run_test_big_letters():
    ...
    # Test 2:
    expected = 'THEREISSIXDAYSOFCLASSUNTILBREAK'
    list1 = ['TfshHaadgib', 'ERgkdhaldnEIsS', 'SIX', 'DlihsdgAklY', 'SOlsnbvF']
    list2 = ['ksdhCLdkgdA', 'sssssSssssSss', 'untilUNTILuntil', 'BREAK']
    answer = big_letters(list1 + list2)
    print('Expected is: ', expected)
    print('Actual is: ', answer)
